...
class MM1Queue(stochastic_queue.StochasticQueue):
    ...
    def __init__(self, vals):
        ...
        self.expected_no_of_customers = vals['expected_no_of_customers']
        self.expected_no_of_customers_in_queue = vals['expected_no_of_customers_in_queue']
        self.expected_waiting_time = vals['expected_waiting_time']
        self.expected_waiting_time_in_queue = vals['expected_waiting_time_in_queue']
